...
export function ForkManager({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border-[3px] border-[#1a1a1a] rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-[6px_6px_0_#1a1a1a]">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 border-[3px] border-[#1a1a1a] rounded-xl bg-[#4ecdc4] flex items-center justify-center -rotate-2 shadow-[3px_3px_0_#1a1a1a] shrink-0">
          ...
          <div>
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-space text-xs font-bold px-2 py-0.5 rounded-md bg-[#fffef2] text-[#1a1a1a] border-2 border-[#1a1a1a] shadow-[1px_1px_0_#1a1a1a]">
        ...
        <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end">
          {forks.length > 0 && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#ffcc5c] hover:bg-[#ffbe3b] text-[#1a1a1a] border-2 border-[#1a1a1a] text-xs font-space font-bold shadow-[2px_2px_0_#1a1a1a] active:translate-x-0.5 active:translate-y-0.5 transition shrink-0 cursor-pointer"
          ...
          <button
            onClick={onRefresh}
            disabled={loading}
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white hover:bg-[#fffef2] text-[#1a1a1a] text-xs font-space font-bold border-2 border-[#1a1a1a] shadow-[2px_2px_0_#1a1a1a] active:translate-x-0.5 active:translate-y-0.5 transition shrink-0 cursor-pointer"
      ...
      {forks.length === 0 ? (
        <div className="bg-white border-[3px] border-[#1a1a1a] rounded-2xl p-12 text-center space-y-3 shadow-[6px_6px_0_#1a1a1a]">
          ...
          <h3 className="font-heading text-xl font-bold text-[#1a1a1a]">No forked repositories found</h3>
          <p className="text-xs text-[#555] max-w-sm mx-auto font-medium">
